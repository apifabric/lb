...
@Component({
  selector: 'SupplierProduct-home',
  templateUrl: './SupplierProduct-home.component.html',
  styleUrls: ['./SupplierProduct-home.component.scss']
})
export class SupplierProductHomeComponent implements AfterViewInit {
